	  ...
	  <section class="top-bar-section">
	    ...
	    <ul class="left">
			...
			<li>
	      	...
	      	<li>
	          <?php echo $this->Html->link(__(("Project Categories"), true), array('controller'=> 'categories', 'action'=>'index', 'admin' => true), array('escape' => false, 'class'=>'admin-panel fancybox.iframe')); ?>
			</li>
	      	<li>
