						...
						<?php 
							...
							if($banner_images){
								foreach ($banner_images as $banner_image):
										...
										echo $this->Html->image("banners".DS."small".DS.$banner_image['Banner']['banner_image'], array(
									    "alt" => "",
								...
								echo $this->Html->image("banners".DS."small".DS.$banner['Banner']['banner_image'], array(
							    "alt" => "",
							    /*'url' => array('controller' => 'images', 'action' => 'view', $image['Image']['id'])*/
								)).'&nbsp;&nbsp;';
							}
