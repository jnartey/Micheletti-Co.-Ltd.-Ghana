	...
	<div class="large-10 columns content">
		...
		<div class="large-6 columns">
			...
			<?php
				...
				echo $this->Form->input('url_description', array('label'=>false, 'placeholder'=>'URL Description or name'));
				echo $this->Form->input('url', array('label'=>false, 'placeholder'=>'URL: eg. about-us'));
