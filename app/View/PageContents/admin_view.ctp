...
<div class="row">
	...
	<div class="large-10 columns content">
		...
		<div class="large-10 columns">
			<div class="panel">
				<?php
					echo '<p><strong>'.__('Page Title: ').'</strong><br />'; 
					echo $page['PageContent']['title'].'</p><br />';
					if($page['PageContent']['sub_title']){
						echo '<p><strong>'.__('Sub Title').'</strong><br />'; 
						echo $page['PageContent']['sub_title'].'</p><br />';
					}
					
					if($page['PageContent']['content']){
						echo '<strong>'.__('Content').'</strong><br />'; 
						echo $page['PageContent']['content'].'<br />';
					}
					
					if($page['PageContent']['page_image']){
						echo $this->html->image('pages'.DS.'large'.DS.$page['PageContent']['page_image'], array('title' => ''));
					}
					
					if($page['PageContent']['icon']){
						echo $this->html->image('pages'.DS.'large'.DS.$page['PageContent']['icon'], array('title' => ''));
					}
				?>
			</div>
		</div>
...
// 									echo $this->Html->link(__("Add", true), array('controller'=> 'pageContents', 'action'=>'add', $page['PageContent']['id'], 'admin' => true), array('escape'=>false, 'class'=>'button tiny success'));
// 								}
